...
namespace Payroll
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            AccountHolderAdapter accJohnDoe = new(johnDoe);
            AccountHolderAdapter accJayneDone = new(jayneDone);

            Banking.PayOut(accJohnDoe, johnDoe.GetSalary() / 12);
            Banking.PayOut(accJayneDone, jayneDone.GetSalary() / 12);
        }
    }
}
